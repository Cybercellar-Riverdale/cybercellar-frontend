...
// import {
//     lineChartDataBlockedEmails,
//     lineChartOptionsBlockedEmails,
...
export default function EmailProcessedLine(props) {
    ...
    const lineChartOptionsEmailProcessed = {
        chart: {
            toolbar: {
                show: false,
            },
            ...
            <Flex align='center'>
              ...
              <Text color='green.500' fontSize='md' fontWeight='700'>
                ...
                <Box minH='260px' minW='100%' mt='auto'>
                    <LineChart
                        chartData={lineChartDataEmailProcessed}
                        chartOptions={lineChartOptionsEmailProcessed}
                    />
                </Box>
            </Flex>
        </Card>

...
// import { pieChartDataDistributionThreat, pieChartOptionsDistributionThreat } from "variables/charts";
        ...
        <Card p='20px' align='center' w='100%' {...rest}>
            <Flex
                ...
                <Text color={textColor} fontSize='xl' fontWeight='600' mt='4px'>
                    Distribution of Threats by Severity
                </Text>
                {/* <Select
          fontSize='sm'
          variant='subtle'
          ...
          <option value='yearly'>Yearly</option>
            ...
            <PieChart
                h='100%'
                w='100%'
                chartData={pieChartDataDistributionThreat}
                chartOptions={pieChartOptionsDistributionThreat}
            />
            {/* <Card
                bg={cardColor}
                flexDirection='row'
